...
describe("PropertyController", () => {
  ...
  it("deve criar uma propriedade com sucesso", async () => {
    ...
    expect(response.body.property.name).toBe("Apartamento");
    expect(response.body.property.description).toBe("Descrição");
    expect(response.body.property.maxGuests).toBe(2);
